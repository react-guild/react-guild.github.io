...
<div class="digest">
    <a href="https://itnext.io/clean-pattern-for-handling-roles-and-permissions-in-large-scale-react-apps-99531869ad71">Шаблоны для создания ролей и разрешений доступа в React приложениях</a>
    <div class="digest-desc">Большинство React приложений выглядят красиво и чисто, пока вы не начинаете добавлять в код условную логику. Ситуация усугубляется еще быстрее, когда вы начинаете добавлять разрешения и роли. Обработка нюансов превращается в кошмар при использовании простых условных выражений или switch операторов. Однако, есть способ лучше о котором вы узнаете прочитав статью.</div>
...
<div class="digest">
    ...
    <div class="digest-desc">При написании JavaScript приложений важно следить за производительностью. Мы хотим, чтобы приложение работало максимально эффективно на любом устройстве, которое может иметь к нему доступ. Будет неправильным предполагать, что веб-приложение будет всегда выполняться на быстрых устройствах. В статье предлагается несколько советов, которые помогут вам повысить общую производительность приложения и обеспечить комфорт для ваших пользователей.</div>
